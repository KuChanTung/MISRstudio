...
dbc = db.connect(dbname = "n054020006",host="127.0.0.1",user="n054020006", 
                 password="ndx82625", default.schema = "public, madlib", verbose = T)
...
#db.q(Select cut,avg(price) from diamonds )
